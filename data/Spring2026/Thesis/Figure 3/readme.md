...
__Figure 3.__ L-curve for the bi-mutual 3-gene, 4-edge network to determine the alpha value. Values next to the datapoints indicate what alpha value the point corresponds to. Inset is zoomed in to show the elbow of the curve more clearly. 
