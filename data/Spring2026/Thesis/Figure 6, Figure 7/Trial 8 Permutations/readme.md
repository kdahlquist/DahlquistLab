...
Tasks:
- Which file has the bar chart?
- OK to have all the data, but need to specify which went into the thesis
- Ideally we have the image, but then the editable source.
