...
All data is in this summary file, with a new sheet for each of the parameters (weights, p, and b). The data was compiled from the output files. The raw input and output files are in the Appendix folder [here](https://github.com/kdahlquist/DahlquistLab/tree/41674af3fb72c6d71b101f3da343b74c58db272f/data/Spring2026/Thesis/Appendix/Fig%201).
