...
All data is in this summary file, with a new sheet for each of the parameters (weights, _P_, and _b_). The data was compiled from the output files. The raw input and output files are in the Appendix folder [here](https://github.com/kdahlquist/DahlquistLab/tree/master/data/Spring2026/Thesis/Appendix/Fig%201).
