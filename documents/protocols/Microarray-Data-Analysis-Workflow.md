...
- The normalization procedure has been verified to work with the 64-bit (x64) version 3.1.0 of R released in April 2014 ([link to download site](https://cran-archive.r-project.org/bin/windows/base/old/3.1.0/) and and version 3.20.1 of the limma package [direct link to download zipped file](https://github.com/kdahlquist/DahlquistLab/blob/master/normalization/Limma_3.20.1.zip?raw=true) on the Windows 7 platform.
