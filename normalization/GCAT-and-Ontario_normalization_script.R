...
# Make sure that this list of strains corresponds to the strains listed in the GCAT and Ontario Targets files above
...
write.table(round(MGOn,digits=4),"GCAT_and_Ontario_Within_Array_Normalization.csv",sep=",",col.names=NA,row.names=TRUE)
...
write.table(round(MGOb,digits=4),"GCAT_and_Ontario_Between_Array_Normalization.csv",sep=",",col.names=NA,row.names=TRUE)
...
write.table(round(MGOu,digits=4),"GCAT_and_Ontario_Unnormalized.csv",sep=",",col.names=NA,row.names=TRUE)
