filename    = 'GCAT_and_Ontario_Between_Array_Normalization.xlsx';
sheetname   = 'GCAT_and_Ontario_Between_Array_';
...
%     Excludes all fold changes that have are an NaN.
    ...
    iTester = isempty(ind15x) | isempty(ind30x) | isempty(ind60x) | isempty(ind90x) | isempty(ind120x);
